    ...
    return (
        ...
        <Grid container>
            ...
            <Grid item xs={12}>
                ...
                <Typography className={classes.infoText} variant="h6" align="center">
            ...
            <Grid className={classes.imgContainers} item xs={12}>
                ...
                <Parallax 
                    strength={200}
                    bgImage={`https://assets.simpleviewinc.com/simpleview/image/upload/c_fill,h_474,q_75,w_640/v1/clients/newyorkstate/AD_2015_122_44de426d-7824-4c67-8331-32143c83903e.jpg`}
                    bgImageAlt="Boone River"
                    className={classes.parallax}
                >
            ...
            <Grid className={classes.imgContainers} item xs={12}>
                ...
                <Parallax 
                    strength={200}
                    bgImage={`https://www.blueridgemountains.com/imager/s3_amazonaws_com/blueridge-2018/images/1920-width/iStock-134561164_5ac8ae049534b01c104dc4019c5230ff.jpg`}
                    bgImageAlt="Blue Ridge Waterfall"
                    className={classes.parallax}
                >
                    ...
                    <Background className={classes.elContainers}>
                        ...
                        >
                            <Button className={classes.button}>
                                ...
                                <Typography variant={media.xs ? 'body1' : 'h5'} align="center">
